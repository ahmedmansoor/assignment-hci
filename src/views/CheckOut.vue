        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="text-gray-600 ml-3">23 Reviews</span>
            </span>
            <span
          ...
          <p class="leading-relaxed">
            ...
            located in Ukulhas. The guest house has a fitness centre and a
            private beach area. Free private parking is available on site.
          </p>
          <DatePicker v-model="range" mode="date" :masks="masks" is-range>
            <template v-slot="{ inputValue, inputEvents, isDragging }">
              <div
                ...
                "
              >
                <p class="font-semibold mr-2">From:</p>
                ...
                <p class="mt-3 mr-2 font-semibold">To:</p>
                <div class="relative flex-grow w-full md:w-auto">
                  <svg
                    class="
                      text-gray-600
